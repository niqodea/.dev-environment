...
vim.keymap.set('n', vim.g.mapleader..'fg/', function() fzf_lua.live_grep({ cmd = "git grep --line-number --column" }) end)
vim.keymap.set('n', vim.g.mapleader..'fg*', function() fzf_lua.grep_cword({ cmd = "git grep --line-number --column" }) end)
vim.keymap.set('v', vim.g.mapleader..'fg*', function() fzf_lua.grep_visual({ cmd = "git grep --line-number --column" }) end)
